...
//        class_addMethod(self, sel, (IMP)dynamicMethodIMPTest2, "v@:{MyStruct=qi*fdB}");
//        return YES;
//    } else if (sel == @selector(test3:)) {
//        class_addMethod(self, sel, (IMP)dynamicMethodIMPTest3, "{MyStruct=qi*fdB}@:{MyStruct=qi*fdB}");
//        return YES;
//    } else {
